...
Living Kali catalog vs this image: `containers/KALI_COVERAGE.md` — HAVE / WANT / SKIP. Flip the status in the same PR as Dockerfile package changes.
...
| [seclists](https://github.com/danielmiessler/SecLists)     | Wordlists (`$SECLISTS` = `/usr/share/seclists`) |
| [whatweb](https://github.com/urbanadventurer/WhatWeb) | Tech fingerprinting |
| [sslscan](https://github.com/rbsec/sslscan) | TLS cipher / certificate scan |
...
| [SSTImap](https://github.com/vladko312/SSTImap)      | Server-side template injection                     |
| [crlfuzz](https://github.com/dwisiswant0/crlfuzz)    | CRLF injection                                     |
| [wpscan](https://github.com/wpscanteam/wpscan)       | WordPress enumeration                              |
| [nikto](https://github.com/sullo/nikto)              | Classic web misconfig scan (noisy; prefer nuclei)  |
| [searchsploit](https://www.exploit-db.com/searchsploit) | Local Exploit-DB lookup                         |
...
| Tool                                 | Description                 |
| ------------------------------------ | --------------------------- |
| [agent-browser](https://github.com/vercel-labs/agent-browser) | Headless Chromium automation |
