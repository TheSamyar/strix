...
| **`/tooling`** | Command-line playbooks for core sandbox tools (nmap, nuclei, httpx, ffuf, subfinder, naabu, katana, sqlmap, sslscan, sstimap, commix, whatweb, crlfuzz, searchsploit, hashid, wpscan, nikto) |
