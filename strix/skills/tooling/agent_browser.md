...
Tabs, parallel sessions, network mocking, video, iframes, dialogs, install
diagnosis, troubleshooting, global flags, and React/Web-Vitals introspection
live in a separate reference to keep this always-loaded skill lean. Pull it the
moment you need any of them:

`load_skill(["agent_browser_advanced"])`

Or the upstream full listing: `agent-browser skills get core --full`.
